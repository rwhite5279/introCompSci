...
"""Pong Demonstration, by Richard White, 2010-01-22
   ...
   FINALLY, WE IMPLEMENT A SCORE COUNTER!!!
...
def initialize():
    ...
    return pygame, main_clock, screen, SCREEN_WIDTH, SCREEN_HEIGHT, WHITE, BLACK, BLUE, YELLOW, left_score, right_score, basicFont
...
def main():
    ...
    pygame, main_clock, screen, SCREEN_WIDTH, SCREEN_HEIGHT, WHITE, BLACK, BLUE, YELLOW, left_score, right_score, basicFont = initialize()
    while left_score < 7 and right_score < 7:
        ...
        prompt_text = basicFont.render("Get ready to play...", True, YELLOW, BLACK)

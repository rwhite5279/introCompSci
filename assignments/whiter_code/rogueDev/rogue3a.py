...
def createRoom(screen, doorLocation, roomOrientation, stdscr, walker, placeWalker=False):
...
def move(screen, direction, stdscr):
...
def main(stdscr):
    ...
    walker = [16,18]
    walker = createRoom(theScreen,(15,15),'right',stdscr, walker, True)
